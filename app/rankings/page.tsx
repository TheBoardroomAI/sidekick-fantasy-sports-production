...
const userTier = "Champion" // "Rookie", "Pro", or "Champion"
            ...
            <div className="flex items-center justify-between">
              ...
              {userTier === "Champion" && (
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="secondary" className="bg-sidekick-action-orange/10 text-sidekick-action-orange">
                    Champion Feature
                  </Badge>
                </div>
              )}
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <CardTitle className="font-headline text-xl">
                Week {selectedWeek} Rankings - {selectedScoring.toUpperCase()}
              </CardTitle>
              <div className="text-sm text-muted-foreground font-body">Last updated: {new Date().toLocaleString()}</div>
            </div>
          </CardHeader>
                  ...
                  >
                    <div className="col-span-1">
                      <div className="flex items-center gap-2">
                        ...
                        {player.tier === "Elite" && <div className="w-2 h-2 bg-sidekick-success-green rounded-full" />}
                      </div>
                    </div>
                    ...
                    <div className="col-span-1">
                      <Badge className={`text-xs border ${getPositionColor(player.position)}`}>{player.position}</Badge>
                    </div>
